package com.hzx.elastic.config;
...
public class HttpClientConfig extends ClientConfig {
    ...
    private final Integer ioReactor;
    ...
    public HttpClientConfig(Builder builder) {
        ...
        this.ioReactor = builder.ioReactor;
    }

    public int getIoReactor() {
        return ioReactor;
    }
    ...
    public static class Builder extends AbstractBuilder<HttpClientConfig, Builder> {
        ...
        public Builder(HttpClientConfig httpClientConfig) {
            ...
            this.ioReactor = httpClientConfig.ioReactor;
        }
        ...
        public Builder ioReactor(int ioReactor) {
